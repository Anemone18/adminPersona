...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('event.listEvent.index', compact('reference'));
    }
    ...
    {
        return view ('event.createEvent.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($postRef) {
            return redirect('event')->with('Complete insert new event');
        } else {
            return redirect('event')->with('Failed insert new event');
        }
    }
    ...
    public function show($key)
    {
        ...
        return view('event.showEvent.index', compact('showPost','image'));
    }
    ...
    public function edit($key)
    {
        ...
        if($showData) {
            return view('event.editEvent.index', compact('showData', 'key'));
        } else {
            return view('event')->with('status', 'Contact ID Not Found');
        }
    }
    ...
    public function update(Request $request, $key)
    {
        ...
        // Start Date - End Date sub string to Store
        $dateRange = $request->deadline;
        $startDate = substr($dateRange,0,10);
        $endDate = substr($dateRange,-10);
        ...
        if($updatePost) {
            return redirect('event')->with('Complete update new event');
        } else {
            return redirect('event')->with('Failed update new event');
        }
    }
